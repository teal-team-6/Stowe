          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-success">
              <CardBody className="pb-0">
                ...
                <div className="text-value" style={{ fontSize: 54 }}>79</div>
                <div>Incoming Calls</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: '70px' }}>
                <Line data={incomingCalls} options={incomingCalls} height={70} />
              </div>
            </Card>
          </Col>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-danger">
              <CardBody className="pb-0">
                ...
                <div className="text-value" style={{ fontSize: 54 }}>0</div>
                <div>Ring No Answer</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: '70px' }}>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value" style={{ fontSize: 54 }}>194</div>
        ...
        <Row>
            ...
            <Card>
              ...
              <CardBody>
                <div className="chart-wrapper">
                  <Bar data={CallsPerHourbar} options={options} />
                </div>
              </CardBody>
            </Card>
            <Card>
              ...
              <CardBody>
                <div className="chart-wrapper">
                  <Bar data={AvgRingTimePerHour} options={options} />
                </div>
              </CardBody>
            </Card>
          </Col>
          ...
          <Row>
            <Col xs="12" sm="12" lg="12"><Card>
              ...
              <CardBody>
                <div className="chart-wrapper">
                  <Bar data={CallsPerAgent} options={options} />
                </div>
              </CardBody>
            </Card>
            </Col>
